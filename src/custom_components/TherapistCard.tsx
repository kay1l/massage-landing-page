...
export default function TherapistCard({ therapist }: { therapist: Therapist }) {
  return (
    <Card className="flex flex-col justify-between min-h-[240px] sm:min-h-[300px] lg:min-h-[340px] shadow-md transform transition-transform duration-300 hover:scale-105 border-[#FEF3E2]">
